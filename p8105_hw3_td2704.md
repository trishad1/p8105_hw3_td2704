...
![](p8105_hw3_td2704_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
<img src="p8105_hw3_td2704_files/figure-gfm/unnamed-chunk-21-1.png" width="90%" />

It looks like there is more activity in the early and late afternoons on
the weekend, on Sundays in particular, perhaps the user waking up late
on weekends or going out more. And overall, the weekdays seems to have
high activity in mornings (likely when the user wakes up) and in the
evenings (before the user goes to bed). The activity count is lowest
between roughly 1300 min to 400 min, which is roughly 10pm to 7am, and
